...
def get_vectorstore_from_url(url) :
    ...
    url_vector_store = Chroma.from_documents(document_chunks,OpenAIEmbeddings())
...
with st.sidebar :
    st.header("Add infor")
    #input web infomation 
    website_url = st.text_input(label="web url")

if website_url is None or website_url == '':
    st.info('plz enter a website url')
